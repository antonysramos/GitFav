  ...
  update(){
    ...
    this.entries.forEach((user) => {
      ...
      row.querySelector('#remove').onclick = () => {
        // const isOk = confirm('Tem certeza que quer excluir essa linha?')
        // if(isOk) {
          this.delete(user)
        // }
      }
  ...
  createRow() {
    ...
    tr.innerHTML = ` 
        <td class="user">
          ...
          <a href="https://github.com/birobirobiro" target="_blank">
            <p>João Inácio Neto</p>
            <span>/birobirobiro</span>
          </a>
        </td>
        <td class="repositories">49</td>
        <td class="followers">24000</td>
        <td>
